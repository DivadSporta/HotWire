...
\begin{figure}[H]
	...
	\resizebox{0.78\textwidth}{!}{%
		\input{../../tikz/Eigene_Bilder/komplettSystemTikz}
	}
...
Die Spannungsversorgung ist ebenfalls aufgeteilt. Die Motoren und der Heizdraht werden mit einer Nennspannung von \(24\,\mathrm{V}\) versorgt. Der Arduino und die Logiksignale arbeiten mit niedrigeren Spannungen. Für zusätzliche Verbraucher oder Hilfsschaltungen kann ein DC-DC-Abwärtswandler eingesetzt werden.
...
Das Gesamtsystem besitzt vier mechanische Achsen. Davon werden drei Achsen unabhängig angesteuert. Die A-Achse ist als Y-Klon ausgeführt und bewegt sich synchron zur Y-Achse. Dadurch kann der Heizdraht auf beiden Seiten geführt werden, ohne dass für die zweite Y-Seite eine eigene Bewegungsberechnung notwendig ist.
...
\begin{table}[H]
	...
	\begin{tabular}{p{5cm} p{4cm} p{6cm}}
		...
		Heizdrahtspannung & \(24\,\mathrm{V}\) & Nennwert \\
		Heizdrahtsteuerung & PWM-MOSFET-Modul & Schalten des Heizdrahtkreises \\
		Drahtdurchmesser & \(0{,}4\,\mathrm{mm}\) & Herstellerwert \\
		PWM-Bereich Heizdraht & \(0\)--\(15\,\%\) & verwendeter Einstellbereich \\
...
\begin{itemize}
	...
	\item Leistungsbeeinflussung des Heizdrahts über ein PWM-MOSFET-Modul,
...
Auch die Heizdrahtleistung muss eingestellt werden. Dazu wird die PWM-Ansteuerung zunächst mit niedriger Leistung getestet. Der verwendete Einstellbereich liegt bei \(0\)--\(15\,\%\). Danach werden Probeschnitte durchgeführt, um Heizleistung und Vorschubgeschwindigkeit aufeinander abzustimmen.
...
\begin{table}[H]
	...
	\begin{tabular}{p{4cm} p{4cm} p{6cm}}
		...
		PWM-Wert Heizdraht & \(0\)--\(15\,\%\) & Tastverhältnis zur Beeinflussung der Heizleistung \\
...
\begin{itemize}
	...
	\item direkte Temperatur- oder Strommessung am Heizdraht ergänzen,
