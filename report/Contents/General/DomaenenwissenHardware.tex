...
Das Heißdrahtschneiden wird in diesem Kapitel als technischer Prozess betrachtet. Es beschreibt die physikalischen Größen, die den Schnitt beeinflussen: Wärmeeintrag, Drahttemperatur, Drahtspannung, Materialverhalten, Vorschubbewegung und Schnittfuge.
...
Für das Projekt wird der Schneidvorgang deshalb als Fertigungsprozess betrachtet, bei dem Werkzeugbewegung, Prozessparameter und Werkstoffverhalten zusammenwirken. In der Fertigungstechnik werden Maßhaltigkeit, Prozessgrößen und Bearbeitungsqualität als zentrale Bewertungsgrößen technischer Fertigungsprozesse beschrieben \cite{Fritz:2022}. Da Schaumstoff ein Kunststoffwerkstoff ist, muss zusätzlich das thermische Verhalten des Materials berücksichtigt werden \cite{Bonnet:2025}.
...
Kunststoffe unterscheiden sich in Aufbau, thermischem Verhalten und Verarbeitung deutlich von metallischen Werkstoffen. Werkstoffauswahl und Verarbeitungseigenschaften sind daher wichtige Grundlagen der Kunststofftechnik \cite{Bonnet:2025}. Bei Schaumstoffen kommt zusätzlich die Zellstruktur hinzu. Sie beeinflusst, wie gleichmäßig das Material beim Schneiden reagiert und wie sauber die Schnittkante wird.
...
Der thermische Schneidprozess ist daher nicht nur von der elektrischen Heizleistung abhängig, sondern auch vom Verhalten des Kunststoffs bei Wärmeeinwirkung. Die Kunststofftechnik beschreibt, dass Kunststoffe je nach Aufbau und Verarbeitungseigenschaften unterschiedlich auf Temperatur reagieren \cite{Bonnet:2025}. Für die Bewertung des Schnitts sind dadurch Prozessparameter und Maßhaltigkeit gemeinsam zu betrachten \cite{Fritz:2022}.
...
\section{PWM-Ansteuerung des Heißdrahts}
\label{sec:pwm_ansteuerung_Heißdraht}
...
Die PWM-Einstellung muss praktisch geprüft werden. Ein bestimmter PWM-Wert ist nicht automatisch für jedes Material geeignet, weil Drahtlänge, Drahtwiderstand, Versorgungsspannung, Materialdicke und Vorschubgeschwindigkeit zusammenwirken. Deshalb gehören Probeschnitte zur Inbetriebnahme des Heißdrahts.
...
Auch elektrische Fehler sind möglich. Dazu gehören lose Verbindungen, ungeeignete Leitungsquerschnitte, unzureichende Masseverbindungen oder eine Überlastung des MOSFET-Moduls. Da der Heißdraht eine stromführende und heiße Last ist, müssen diese Fehler besonders sorgfältig vermieden werden.
...
Die Bewertung der Schnittqualität orientiert sich damit an typischen Kriterien der Fertigungstechnik. Maßhaltigkeit, Wiederholbarkeit und die Wirkung der Prozessparameter auf das Bearbeitungsergebnis sind zentrale Merkmale zur Beurteilung eines Fertigungsprozesses \cite{Fritz:2022}.
