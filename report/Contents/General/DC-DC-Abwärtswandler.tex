...
Für den direkten Betrieb der Logikschaltungen wird jedoch eine stabile Versorgungsspannung von 5\,V benötigt \cite{arduino:uno-datasheet-datasheet}. 
...
Der Arduino Uno unterstützt laut Datenblatt Eingangsspannungen von 6\,V bis 20\,V am Anschluss \PYTHON{VIN} \cite{arduino:uno-datasheet}. 
...
\begin{itemize}
	...
	\item Arduino: \textit{Arduino Uno Rev3 Datasheet}. Technisches Datenblatt, 2025. \cite{arduino:uno-datasheet}
