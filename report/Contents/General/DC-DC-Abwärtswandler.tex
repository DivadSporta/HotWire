...
In elektronischen Systemen werden variable Spannungsbereiche benötigt. Mikrocontroller, Sensoren und weitere elektronische Baugruppen arbeiten mit niedrigen Gleichspannungen wie 3,3\,V oder 5\,V, während andere Komponenten höhere Versorgungsspannungen benötigen. Spannungswandler ermöglichen die Anpassung vorhandener Versorgungsspannungen an die jeweiligen Verbraucher.

Für die Versorgung von Mikrocontrollern und Logikschaltungen wird häufig ein DC-DC-Abwärtswandler verwendet. Dieser reduziert eine höhere Eingangsspannung auf eine stabile Ausgangsspannung. Im Projekt wird hierfür ein Buck-Converter-Modul auf Basis des LM2596 beziehungsweise MP2307 eingesetzt.

Der Arduino Uno kann über den VIN-Anschluss mit einer Eingangsspannung von bis zu 20\,V betrieben werden. Für den direkten Betrieb der Logikschaltungen wird jedoch eine stabile Versorgungsspannung von 5\,V benötigt. \cite{Arduino:Uno} Der eingesetzte DC-DC-Abwärtswandler übernimmt daher die Spannungsanpassung zwischen Netzteil und Mikrocontroller.

Im Gegensatz zu linearen Spannungsreglern arbeitet ein Abwärtswandler im Schaltbetrieb. Dadurch entstehen geringere Verlustleistungen und eine reduzierte Wärmeentwicklung. Gleichzeitig werden hohe Wirkungsgrade erreicht. \cite{Schlienz:2020}
...
Der eingesetzte Wandler besitzt eine kompakte Bauform, hohe Effizienz sowie eine einfache Integration in elektronische Schaltungen. Aufgrund der hohen Strombelastbarkeit eignet sich das Modul für Mikrocontroller-Anwendungen und kleinere elektronische Verbraucher.
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		\hline
		Eingangsspannung & 4,75 - 24 V DC \\
		\hline
		Ausgangsspannung & 0,93 - 18 V DC \\
		\hline
...
Die Ausgangsspannung \(U_a\) ergibt sich aus der Eingangsspannung \(U_e\) und dem Tastverhältnis \(v_T\) der PWM. Die Ausgangsspannung hängt somit direkt vom Tastverhältnis ab. Durch die hohe Schaltfrequenz kann eine kompakte und effiziente Spannungsregelung realisiert werden. \cite{Schlienz:2020}
...
Durch den Schaltbetrieb erreicht der Abwärtswandler deutlich höhere Wirkungsgrade als lineare Spannungsregler. Beim verwendeten Modul sind Wirkungsgrade von bis zu 98\,\% möglich. \cite{MP2307:Datasheet}
...
Die Verlustleistung wird überwiegend in Wärme umgewandelt und führt zu einer Erwärmung der elektronischen Bauteile. Besonders bei höheren Lastströmen müssen diese Verluste berücksichtigt werden. \cite{Schlienz:2020}

\section{Schutzvorrichtungen}

Der eingesetzte DC-DC-Wandler verfügt über verschiedene Schutzmechanismen zum Schutz der Elektronik.
...
\begin{itemize}
	\item \textbf{IN+}: positive Eingangsspannung
	\item \textbf{IN-}: Masse der Eingangsspannung
	\item \textbf{OUT+}: positive Ausgangsspannung
	\item \textbf{OUT-}: Masse der Ausgangsspannung
\end{itemize}

Vor dem Anschluss an die Elektronik muss die gewünschte Ausgangsspannung mithilfe des integrierten Potentiometers eingestellt werden.

Anschließend wird die Ausgangsspannung mit dem Arduino Uno sowie weiteren elektronischen Baugruppen verbunden.
