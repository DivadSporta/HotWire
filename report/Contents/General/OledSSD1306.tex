...
\begin{center}
	...
	\cite{Velleman:WPI438}
	
\end{center}

Bei der Ansteuerung eines OLED-Displays über das I\textsuperscript{2}C-Protokoll erfolgt der serielle Datenaustausch über die beiden Leitungen \ac{sda} und \ac{scl}. Dabei ermöglicht das I\textsuperscript{2}C-Protokoll eine bidirektionale Kommunikation über zwei Leitungen. Mehrere Geräte können dabei über individuelle Adressen gezielt angesprochen werden.\cite{Velleman:WPI438UserManual}

\begin{itemize}
	\item \ac{sda} überträgt die eigentlichen Datenbits, beispielsweise Befehle oder Bildinhalte.
	\item \ac{scl} gibt den Takt vor, der bestimmt, wann ein Bit gelesen oder geschrieben wird.
\end{itemize}
...
\begin{center}
	...
	\begin{tabular}{|p{5cm}|p{9cm}|}
		...
		\hline
	\end{tabular}
	\cite{arduinoLibraries:2025}
	\cite{AdafruitGFX:2023}
\end{center}
