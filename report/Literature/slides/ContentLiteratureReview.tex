...
\Mysection{Leistungselektronik, 5. Auflage}

\STANDARD{Beschreibung}
{ 
	Das Buch behandelt Grundlagen und Anwendungen der Leistungselektronik. Es beschreibt Bauelemente, Schaltvorgänge und leistungselektronische Systeme und eignet sich zur allgemeinen Einordnung von Schaltungen zur Leistungssteuerung. Die Quelle wird mit \cite{Zach:2015} belegt.
	
	\bigskip
	
	\textbf{Limitation:} Die Quelle ist umfangreich und behandelt Leistungselektronik allgemein. Konkrete Herstellerdaten einzelner Module müssen zusätzlich über Datenblätter geprüft werden.
	
	\scriptsize{\textbf{Keywords:} Leistungselektronik, Schaltvorgang, Leistungssteuerung, Halbleiter, Energieumwandlung}
}
